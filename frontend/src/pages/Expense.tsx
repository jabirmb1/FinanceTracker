...
const Expense: React.FC = () => {
  ...
  // Fix #9: derive cat from categories so it's never stale / pointing at a deleted category
  const [cat, setCat] = useState<string>(() => categories[0] || "");

  // Keep cat in sync if categories change and the selected one no longer exists
  useEffect(() => {
